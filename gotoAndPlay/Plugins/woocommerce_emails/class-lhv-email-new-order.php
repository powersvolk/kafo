...
if ( ! class_exists( 'LHV_Email_New_Order' ) ) :
 ...
 *
 * @class       LHV_Email_New_Order
 * @version     2.0.0
 * @package     WooCommerce/Classes/Emails
 * @author      WooThemes,GTAP
 * @extends     WC_Email
 */
class LHV_Email_New_Order extends WC_Email {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->id               = 'new_lhv_order';
		$this->title            = __( 'New LHV order', 'woocommerce' );
...
return new LHV_Email_New_Order();
